  ...
  return (
    <main className='bg-gradient-to-b from-slate-950 via-slate-800 to-slate-950 animate-movingBg min-h-screen p-5 md:px-20'>
      <div className="flex flex-col items-center justify-center h-full text-center">
        ...
        <a href="/forms">
          <h1 className="mt-8 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-2xl transition duration-300 transform hover:scale-105 focus:outline-none focus:shadow-outline-blue">Register Now</h1>
        </a>
        ...
        <a href="https://tryhackme.com/jr/editactf2023">
          Click Here to Join
            ...
            <div className="mt-10">
                <h2 className="text-3xl py-5 text-blue-200 animate__animated animate__fadeIn">Want to Get Started?</h2>
