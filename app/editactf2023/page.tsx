  ...
  return (
    <main className='bg-gradient-to-b from-slate-950 via-slate-800 to-slate-950 animate-movingBg min-h-screen md:px-20'>
      <div className=''>
        ...
        <div className="bg-inherit my-3 text-white border p-5 md:w-1/2 mx-auto  rounded-lg animate__animated animate__fadeInDown shadow-md shadow-blue-300" >
        ...
        <div className="bg-inherit my-3 text-white border p-5 rounded-lg animate__animated animate__fadeInDown md:w-1/2 mx-auto shadow-md shadow-blue-300" >
